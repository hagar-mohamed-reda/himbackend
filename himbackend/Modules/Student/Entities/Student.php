...
use Modules\Academic\Entities\Student as AcademicStudent;
use DB;
...
class Student extends Model {
    ...
    public function commission() {
        return $this->belongsTo('Modules\Student\Entities\Commission', 'commission_id');
    }
    ...
    public function toAcademicStudent() {
        return AcademicStudent::find($this->id);
    }


    public function getAgeFrom1_10() {
        $date = date('Y') . "-10-01";
        //return $this->birthdate;

        return $this->birthdate? str_replace('years before', '', Carbon::parse($this->birthdate)->diffForHumans(Carbon::parse($date))) : '';
    }
