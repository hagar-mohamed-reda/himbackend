    ...
    <div class="row" style='direction: ltr !important;'>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
            ...
            <div class="text-center" style='font-weight: bolder !important;font-size:14px !important;background-color: #d4d4d4 !important;border: 1px solid black;'>
                 كشف حضور وغياب الطلبة - مادة {{ $course->name }}  
                 <div class="row">
                     <div class="col-md-6" style="display-inline:block;">{{ $group->name ?? ''}} جروب </div>
                     @if($section->name ?? '')
                     <div class="col-md-6" style="display-inline:block;">{{ $section->name ?? ''}} سكشن  </div>
                     @else
