...
*/
 ...
 Route::get('users/api-token', 'UserController@getApiToken');
...
Route::group(['middleware' => 'api_auth'], function () {
    ...
    Route::post("update-system-setting-term", "DashboardController@updateSystemSettingsTerm");
    Route::post("update-system-setting-year", "DashboardController@updateSystemSettingsYear");
    ...
    Route::post("import-result2", "ImportController@importResult2");
    Route::post("import-result3", "ImportController@importResult3");
    Route::post("import-result4", "ImportController@importResult4");
});
