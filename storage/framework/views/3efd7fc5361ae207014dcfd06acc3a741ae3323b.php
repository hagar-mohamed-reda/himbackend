...
background-image: url(<?php echo e(url('/logo_t.png')); ?>);
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-3 pr-0 pl-1">
                    <img src="<?php echo e(url('/logo.png')); ?>" width="100%" style="margin-top: 2rem;">
                    <img src="<?php echo e($student->personal_photo_url); ?>" width="100%"  height='100px'>
		    ...
		    <img src="<?php echo e(url('/amid.png')); ?>" width="100%" height='36px' >
                ...
                <div class="col-9" style="text-align: right;">
                    ...
                    <?php if(  strlen($student->name) >= 35 ): ?>
                        <h6 class="mt-3" style='font-size: 13.9px !important;'>الإسم :  <?php echo e($student->name); ?></h6>
                    <?php else: ?>
                        <h6 class="mt-3">الإسم :  <?php echo e($student->name); ?></h6>
                    <?php endif; ?>
                    <h6 class="mt-3" >المستوي : <?php echo e(optional($student->level)->name); ?></h6>
                    <h6 class="mt-3" >الكود : <?php echo e($student->code); ?></h6>
                    <h6 class="mt-3" >الشعبة : <?php echo e(optional($student->division)->name); ?></h6>
