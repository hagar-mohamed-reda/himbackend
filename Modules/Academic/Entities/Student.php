...
class Student extends StudentOrigin {
    ...
    public function getCGPA() {
        ...
        $courses = StudentRegisterCourse::query()
                ->join('academic_courses', 'academic_courses.id', '=', 'course_id')
                ->where('student_id', $this->id)
                ->select('*', 'academic_student_register_courses.id as id')->get();

             $registerHours = StudentRegisterCourse::query()
                ->join('academic_courses', 'academic_courses.id', '=', 'course_id')
                ->where('student_id', $this->id)
                ->select('*', 'academic_student_register_courses.id as id')->sum('credit_hour');
