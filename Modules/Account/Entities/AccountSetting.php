...
class AccountSetting extends Model
{
    ...
    public static function getCurrentAcademicYear() {
      // get current year
        $resource = AcademicYear::find(optional(DB::table('globale_settings')->find(7))->value);
    ...
    public static function canStudentGetService(Service $service, Student $student, $ignoreRepeat=false) {
        ...
        // if ($valid) {
            ...
            if ($student->is_current_installed || $student->is_old_installed) {
                ...
                $rows = \Modules\Account\Entities\Installment::where('student_id', $student->id)->get();
        ...
        // check on card export settings ali
