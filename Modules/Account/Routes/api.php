...
Route::group(['middleware' => 'api_auth'], function () {
    Route::prefix('account')->group(function() {
        ...
        // service template id routes
        Route::get('service_templates', 'ServiceTemplateController@index');
        ...
        Route::get('services/print', 'AccountController@printService');
        ...
        Route::post('persons/update/{person}', 'PersonController@update');
        Route::post('persons/delete/{person}', 'PersonController@destroy'); 
        ...
        // Transformations Private routes
        Route::get('transformations_private', 'TransformationController@indexPrivate');
        ...
        Route::get('report/get-student-model-pay', 'ReportController@studentModelPay');
        ...
        Route::post('change_payment_status', 'AccountController@changePaymentStatus');
       ...
       Route::get('levels', function(){
        ...
        Route::get('theaters', function(){
          return DB::table('theaters')->get();
        });
         Route::get('commissions', function(){
          return Modules\Student\Entities\Commission::with('theater','level','division','commission_type')->get();
        });
         Route::get('student_distributions', function(){
          return DB::table('student_distributions')->get();
        });
        ...
        Route::get('models', function(){
            $expense = Modules\Account\Entities\AcademicYearExpenseDetail::where('service_id',12)->get();
          return $expense;
        });
        
        Route::get('max_set_number', function(){
          return  DB::table('students')->max('set_number');
        });
        ...
        Route::get('sync/report/payment-student-blocked', 'ReportController@syncPaymentStudentBlocked');
