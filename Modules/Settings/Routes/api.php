...
Route::group(['middleware' => 'api_auth'], function () {
    ...
    //commission_types
    Route::get('commission_types','CommissionTypeController@index');
    Route::post('commission_types/store', 'CommissionTypeController@store');
    Route::post('commission_types/update/{resource}', 'CommissionTypeController@update');
    Route::post('commission_types/delete/{resource}', 'CommissionTypeController@destroy');
